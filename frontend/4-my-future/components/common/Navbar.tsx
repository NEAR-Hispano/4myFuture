...
function Navbar() {
  ...
  return (
    <div>
      <div className="w-full flex flex-row items-center p-2 justify-between shadow-xs bg-[#7B62D9] fixed">
        <div className="">
          <img
        ...
        <div className="navbar-menu hidden lg:block lg:w-2/5 lg:text-right">
          <a
            className="block lg:inline-block mt-4 lg:mt-0 mr-10 text-white hover:text-indigo-600"
            onClick={() => {
