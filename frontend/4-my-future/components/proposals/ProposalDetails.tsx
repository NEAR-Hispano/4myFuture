...
const pauseProposal = async () => {
  ...
  return (
    <div className="w-2/3 h-screen pb-6 pr-6 pl-6 mt-8 bg-gray-400 border-2  shadow-xl font-sans my-4">
   ...
   <div className="mt-3 md:mt-4 lg:mt-0 flex flex-col lg:flex-row items-strech justify-center lg:space-x-8">
     <div className="lg:w-1/2 flex justify-between items-strech bg-gray-50  px-2 py-20 md:py-6 md:px-6 lg:py-24">
       ...
       <div className="">
         <div className="lg:relative">
           ...
           <img src={proposal.photos[0]} className="w-full h-96 object-contain" />
           </a>
     ...
     <div className="flex items-center flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6 lg:space-x-8 mt-8 md:mt-16">
       {proposal.status == 0 && proposal.user != user.id ? 
        ...
        <button className="w-full md:w-3/5 border border-gray-800 text-base font-medium leading-none uppercase py-6 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 bg-green-500 text-white"  onClick={handleEnableModal} >contribute</button>
