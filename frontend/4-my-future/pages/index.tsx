                ...
                <ul className="space-y-12">
                    <li className="flex -mx-4">
                        ...
                        <div className="px-4">
                            ...
                            It is very easy to create proposals, contribute and receive funds.
                            </p>
                        </div>
                    </li>
                    <li className="flex -mx-4">
                        ...
                        <div className="px-4">
                            ...
                            <p className="text-gray-500 leading-loose">
                            Being on the NEAR blockchain makes it easy to publicly view and audit transactions
                            </p>
                        </div>
                    </li>
                    <li className="flex -mx-4">
                        ...
                        <div className="px-4">
                            ...
                            <p className="text-gray-500 leading-loose">
                            Contributors are rewarded with NFTs and soon with tokens native to the platform.
                            </p>
                        </div>
                    </li>
                </ul>
...
<div className="container flex flex-col mx-auto w-full items-center justify-center mt-5">
            ...
            <div className="transition duration-500 shadow ease-in-out transform hover:-translate-y-1 hover:shadow-lg select-none cursor-pointer bg-white  rounded-md flex flex-1 items-center p-4">
                <div className="flex flex-col w-10 h-10 justify-center items-center mr-4">
                    <a href="#" className="block relative">
                        <img alt="profil" src="https://ipfs.infura.io/ipfs/QmPcGmi195SxtGeM7U6TzhAMqq8Xd1hwaYn9iBArbQEiyA" className="mx-auto object-cover rounded-full h-10 w-10 "/>
                    </a>
                </div>
                ...
                <button className="w-24 text-right flex justify-end">
                    <svg width="12" fill="currentColor" height="12" className="hover:text-gray-800 dark:hover:text-white  text-gray-500" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="flex items-center space-y-24 md:space-y-0 flex-col md:flex-row justify evenly">
        <div className="p-4 relative">
            <div className="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2">
                <a href="#" className="block relative">
                    <img alt="profil" src="/landing/near-l.png" className="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"/>
                </a>
            </div>
            <div className="bg-white  rounded-lg shadow px-8 py-4 pt-24">
                <div className="text-center">
                    ...
                    Co-creator of 4myfuture, Systems Engineering student, mobile application developer, Dapps developer.
                    </p>
                </div>
