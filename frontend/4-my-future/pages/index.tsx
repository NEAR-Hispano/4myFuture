              ...
              <div className="p-4 relative">
                <div className="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2">
                  <a href="#" className="block relative">
                    <img
                      alt="profil"
                      src="https://firebasestorage.googleapis.com/v0/b/myfurue.appspot.com/o/fotonear-removebg-preview.png?alt=media&token=ad3742e6-9d13-4340-a5ef-fab339588f7a"
                      className="mx-auto object-contain rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"
                    />
                  </a>
                </div>
              ...
              <div className="p-4 relative">
                <div className="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2">
                  <a href="#" className="block relative">
                    <img
                      alt="profil"
                      src="https://firebasestorage.googleapis.com/v0/b/myfurue.appspot.com/o/edward-foto-removebg-preview-removebg-preview.png?alt=media&token=27209588-7ad1-486c-9bd2-6ab68092cb94"
                      className="mx-auto object-contain rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"
                    />
                  </a>
                </div>
